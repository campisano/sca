...
public class CreationDB {
	...
	public static void main(String[] args) {
			...
			Disciplina disc3 = new Disciplina("GESTÃO ESTRATÉGICA", "GADM7741",
					2);
			Disciplina disc4 = new Disciplina("ECONOMIA BRASILEIRA",
					"GADM7756", 2);
			...
			Disciplina disc9 = new Disciplina("INTRODUÇÃO À ADMINISTRAÇÃO",
					"GTSI1215", 2);
			Disciplina disc10 = new Disciplina("SISTEMAS OPERACIONAIS",
					"GTSI1221", 4);
			Disciplina disc11 = new Disciplina("ESTRUTURAS DE DADOS",
					"GTSI1222", 4);
			Disciplina disc12 = new Disciplina("MATEMÁTICA DISCRETA",
					"GTSI1223", 4);
			...
			Disciplina disc16 = new Disciplina(
					"PROGRAMAÇÃO ORIENTADA A OBJETOS", "GTSI1233", 4);
			Disciplina disc17 = new Disciplina("EMPREENDEDORISMO", "GTSI1234",
					2);
			Disciplina disc18 = new Disciplina("ESTATÍSTICA E PROBABILIDADE",
					"GTSI1235", 4);
			Disciplina disc19 = new Disciplina(
					"PROJETO E CONSTRUÇÃO DE SISTEMAS", "GTSI1254", 4);
			...
			Disciplina disc24 = new Disciplina("PROJETO DE BANCO DE DADOS",
					"GTSI7311", 4);
			Disciplina disc25 = new Disciplina(
					"MODELAGEM DE PROJETO DE SISTEMAS", "GTSI7312", 4);
			Disciplina disc26 = new Disciplina(
					"ADMINISTRAÇÃO DE BANCO DE DADOS", "GTSI7415", 4);
			...
			Disciplina disc28 = new Disciplina("PROGRAMAÇÃO DE SERVIDORES WEB",
					"GTSI7518", 4);
			Disciplina disc29 = new Disciplina("PROJETO DE INTERFACES",
					"GTSI7519", 4);
			Disciplina disc30 = new Disciplina("PADRÕES DE SOFTWARE",
					"GTSI7520", 4);
			Disciplina disc31 = new Disciplina("ENGENHARIA DE SOFTWARE",
					"GTSI7521", 4);
			Disciplina disc32 = new Disciplina("PROJETO FINAL I", "GTSI7523", 4);
			Disciplina disc33 = new Disciplina(
					"TÓPICOS AVANÇADOS EM INFORMÁTICA", "GTSI7624", 2);
			Disciplina disc34 = new Disciplina("NEGÓCIOS NA INTERNET",
					"GTSI7625", 2);
			...
			Disciplina[] disciplinas = { disc1, disc2, disc3, disc4, disc5,
					disc6, disc7, disc8, disc9, disc10, disc11, disc12, disc13,
					disc14, disc15, disc16, disc17, disc18, disc19, disc20,
					disc21, disc22, disc23, disc24, disc25, disc26, disc27,
					disc28, disc29, disc30, disc31, disc32, disc33, disc34,
					disc35, disc36, disc37, disc38, disc39 };
			...
			Turma[] turmas = { turma1, turma2, turma3, turma4, turma5, turma6,
					...
					turma14, turma15, turma16, turma17, turma18, turma19,
					turma20, turma21, turma22, turma23, turma24, turma25,
					turma26, turma27, turma28, turma29, turma30, turma31,
					turma32, turma33, turma34, turma35, turma36, turma37,
					turma38, turma39 };
